package com.example.gd8_d_0671.adapters
...
import com.example.gd8_d_0671.AddEditActivity
import com.example.gd8_d_0671.MainActivity
import com.example.gd8_d_0671.R
import java.util.*
...
class MahasiwaAdapter (private var mahasiswaList: List<Mahasiswa>, context: Context) :
    ...
    inner class ViewHolder(itenView: View) : RecyclerView.ViewHolder(itenView) {
        ...
        init {
            ...
            tvProdi = itenView.findViewById(R.id.tv_prodi)
